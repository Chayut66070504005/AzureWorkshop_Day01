...
# Load secret from environment for safety. Provide a default for local development only.
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'dev-local-secret-change-me')
